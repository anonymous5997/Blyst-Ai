export default function WhyChoose() {
  ...
  return (
    <section className="mt-12 md:mt-16" aria-label="Why choose Blyst AI">
      <h2 className="text-xl md:text-2xl font-semibold text-white">Why Choose Blyst AI</h2>
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {points.map((x) => (
          <div key={x.h} className="rounded-xl border border-white/10 bg-white/5 p-5 text-white/80">
